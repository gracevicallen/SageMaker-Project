...
for part_number in sorted(
    ...
    try:
        ...
        for month_number in range(
            ...
            # Use all actual data available before
            ...
            # Retrain before each forecast month.
            model = train_model(
                training_rows,
                feature_columns,
            )
...
if not all_results:
    raise RuntimeError(
        "No Version 3 rolling forecasts "
        "completed successfully."
    )

print(
    "\nVersion 3 rolling backtest complete."
)
